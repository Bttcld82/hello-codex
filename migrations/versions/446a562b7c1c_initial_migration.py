...
Revision ID: 446a562b7c1c
Revises: 
Create Date: 2025-11-18 12:58:26.745328
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.CheckConstraint('duration_hours > 0', name='ck_time_entries_duration_positive'),
